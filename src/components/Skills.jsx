        ...
        >
          {skillsData.map((skill, id) => (
            <div
              ...
              key={id}
            >
              <div className="h-full w-full rounded-lg border border-teal-900 bg-teal-700 dark:bg-teal-500 shadow-none shadow-gray-50 group-hover:border-violet-500 transition-all duration-500">
                <div className="flex -translate-y-[1px] justify-center">
                  <div className="w-3/4">
                    <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-teal-900 to-transparent" />
                  </div>
                </div>
